...
exports = module.exports = __nccwpck_require__(564);
exports.log = log;
...
const getTheme = __nccwpck_require__(732);
...
`;
  ...
  fs.writeFile(
    __nccwpck_require__.ab + "juejin-card.svg",
    svgContent,
    (err) => {
      if (err) throw err;
...
const { render, constructItem } = __nccwpck_require__(363);
const { formatNumber } = __nccwpck_require__(795);
...
(() => {
const getJuejinInfo = __nccwpck_require__(178);
const renderJuejinCard = __nccwpck_require__(60);
